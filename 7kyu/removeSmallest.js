// Kata Link: https://www.codewars.com/kata/563cf89eb4747c5fb100001b/javascript
...
// However, just as she finished rating all exhibitions, she's off to an important fair, so she asks you to write a program that
// tells her the ratings of the items after one removed the lowest one. Fair enough.
...
function removeSmallest(numbers) {
  ...
  return numbers.filter((v, i) => i !== index);
}

console.log(removeSmallest([2, 1, 2, 3, 4, 5, 1]));
